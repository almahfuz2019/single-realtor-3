          ...
          >
            ...
            <div className="border-b-2 pb-4 border-b-primary border border-x-0 border-t-0">
              <div className="flex items-center gap-10 justify-start">
                ...
                />
                <div>
                  <h3 className="lg:text-[32px] text-2xl font-medium montserrat-font ">
                    Anna Waugh
                  </h3>
                  <p className="lg:text-2xl text-xl font-light  open-sans-font">
                    Happy Client
                  </p>
              ...
              <div>
                ...
                <p className="text-justify text-base mt-6 montserrat-font">
