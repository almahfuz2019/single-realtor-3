          ...
          <Tabs>
            ...
            <TabPanel>
              <form className="flex flex-wrap lg:flex-nowrap justify-center space-y-4 lg:space-y-0 lg:space-x-4 open-sans-font sm:px-20 lg:px-0">
                ...
                <button
                  type="submit"
                  className="w-full lg:w-1/4 p-2 bg-[#C61414CC] text-2xl text-white rounded-xl transition duration-300 ease-in-out transform  hover:shadow-2xl hover:bg-gradient-to-r hover:from-[#ea242493] hover:to-[#c61414ed]"
                >
                  Browse
                </button>
              </form>
